 ...
 * @copyright Copyright (c) 2015 Art CMS
 * @license http://www.apache.org/licenses/LICENSE-2.0
 */

namespace artsoft\comments;
...
class Comments extends \yii\base\Module
{
     ...
     * @var string
     */
    public $controllerNamespace = 'artsoft\comments\controllers';
     ...
     * 
     * Note! `artsoft\comments\components\Akismet` component must be configured:
     * 
     * ~~~
     * 'components' => [
     *     'akismet' => [
     *         'class' => 'artsoft\comments\components\Akismet',
     *         'apiKey' => '*******',
     *     ],
     * ]
     * ~~~
    ...
    public function registerTranslations()
    {
        Yii::$app->i18n->translations['yii2-comments/*'] = [
            ...
            'basePath' => '@vendor/artsoft/yii2-comments/messages',
            'fileMap' => [
    ...
    public static function getMultilingUrl($url)
    {
        ...
        $languageRedirects = Yii::$app->art->languageRedirects;
